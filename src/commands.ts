...
export const JAVA_GET_PROJECT_SETTINGS = "vscode.java.getProjectSettings";

export const JAVA_GET_PROJECT_SETTINGS_FROM_TYPE = "vscode.java.getProjectSettingsFromType";
